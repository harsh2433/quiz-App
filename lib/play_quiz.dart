...
import 'package:quiz/quiz_play_widgets.dart';
...
class _PlayQuizState extends State<PlayQuiz> {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(DiagnosticsProperty<QuerySnapshot>('questionsSnapshot', questionsSnapshot));
  }
  }
  ...
  Widget build(BuildContext context) {
    return Container(
          child: Column(
            ...
            children:[
            Text("Q${widget.index+1} ${widget.questionModel.question}",style: TextStyle(fontSize: 17,color:
             Colors.black87),),
            SizedBox(height: 12,),
              GestureDetector(
                onTap: (){
